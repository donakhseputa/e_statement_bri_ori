...
require_once('callback samples/callback_database.php');
 ...
 * for remote mailbox
 */
$bmh->mailhost           = '202.51.252.22'; // your mail server
$bmh->mailbox_username   = 'danareksa@indocorp.com'; // your mailbox username
$bmh->mailbox_password   = 'trial'; // your mailbox password
