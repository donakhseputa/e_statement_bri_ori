...
$pdf->Cell(0, 0, 'CODE 128 A ' .$a ." " .$b . "  style = 0" . $s , 0, 1);
$pdf->write1DBarcode('A123456790123456790A', 'C128A', '', '', $a, '', $b , $style, 'N');
...
$a =60;
$b = 0.3;
$pdf->Cell(0, 0, 'CODE 128 A ' .$a ." " .$b . "  style = 1" . $s , 0, 1);
$pdf->write1DBarcode('A123456790123456790A', 'C128A', '', '', $a, '', $b , $style1, 'N');
...
$pdf->write1DBarcode('A123456790123456790A', 'C128B', '', '', '60', '', 0.4, $style, 'N');

$pdf->Ln();

// CODE 128 C
$pdf->Cell(0, 0, 'CODE 128 C', 0, 1);
$pdf->write1DBarcode('01234567890123456789', 'C128C', '', '', '', 18, 0.4, $style, 'N');
