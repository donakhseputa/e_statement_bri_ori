    ...
    <script>
		...
		function cekForm(){
			...
			if(confirm('Untuk menghindari kesalahan loading, tolong dicek kembali!\n\nApakah Anda ingin melanjutkan?')){
				if(product=='BE'){
					$("#form_upload_detail").attr('action','proses_loading_detail.php?pr='+pr+'|dat_to_pdf');
				}else{
		...
		function showRecord(){
			...
			$.post("script_loading_detail_b.php",{pr:pr+'|show_record|'+blth},function(respon){
			...
			$.post("script_loading_detail_b.php",{pr:pr+'|show_file_mcustomer|'+blth},function(respon){
		...
		function show_det(m_loading_id){
			...
			Loaddiv('div_detail','script_loading_detail.php','act=show_detail&m_loading_id='+m_loading_id+'&flagtrans='+flagtrans+'&offset=0&input_search='+input_search);
                                    ...
                                    <table width="80%" border="0" cellpadding="2" cellspacing="2" align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td width="15%" colspan="2">
                                                ...
                                                </div> <i><font size="-4">hanya berlaku untuk "Menggunakan Nomor Rekening" dan "Menggunakan Nomor Customer"</font></i>
                                            </td>
                                        </tr>
                                        <tr>
                                        	<td colspan="3" align="left">
                                            	<table>
                                                    <tr>
                                                        ...
                                                        <td height="30">
                                                        	<label>
                                                        	<input type="radio" name="rad_cust" id="rad_cust2" value="2" disabled="disabled" />
                                                            Menggunakan Nomor Rekening
                                                            </label>
                                                        </td>
                                                        <td height="30">
                                                        	<label>
                                                        	<input type="radio" name="rad_cust" id="rad_cust3" value="3" disabled="disabled" />
                                                            Menggunakan Nomor Customer
                                                            </label>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            <td height="30" colspan="3" align="center" valign="middle">Silakan masukkan file berformat .txt</td>
                                        </tr>
                                        <tr>
