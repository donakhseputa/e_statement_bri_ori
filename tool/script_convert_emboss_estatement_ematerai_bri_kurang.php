...
function proses_split_dan_inject($n_split, $temp, $temp_status )
{
	...
	$sql = "SELECT * ,nomor_rekening as policy_number
			from detail_112024_mt
			where nama_file like '%CYC_101124_E_MTR%' and
			nomor_rekening NOT IN (select nomor_rekening from detail_112024_bc where nama_file LIKE '%CYC_101124_E_MTR_P0%' group by nomor_rekening)
			and nomor_rekening NOT IN (select nomor_rekening from detail_112024_bc where nama_file LIKE '%CYC_101124_E_MTR_P1%' group by nomor_rekening)
