...
<?
	...
	function doPDF($cdata,$header,$password_pdf,$blth,$file,$detail,$flag_case,$flagtrans,$barcode, $dt_kurir1){
		...
		$pdf->SetX($x_biodata);$pdf->MultiCell(50,5,$cdata['custname2'],0,'L',0,1);$tmp_excel_bri_corp1.="('".$cdata['custname2'];$output_excel_nama.=str_replace(' ','_',$cdata['custname2']);
		$pdf->SetX($x_biodata);$pdf->MultiCell(50,5,$cdata['addr1'],0,'L',0,1);$tmp_excel_bri_corp1.="(".$cdata['addr1'];
		$pdf->SetX($x_biodata);$pdf->MultiCell(50,5,$cdata['addr2'],0,'L',0,1);$tmp_excel_bri_corp1.=$cdata['addr2'];
		$pdf->SetX($x_biodata);$pdf->MultiCell(50,5,$cdata['addr3'],0,'L',0,1);$tmp_excel_bri_corp1.=$cdata['addr3'];
		$pdf->SetX($x_biodata);$pdf->MultiCell(50,5,$cdata['city'].' '.$cdata['zipcd'],0,'L',0,1);$tmp_excel_bri_corp1.=$cdata['city']." ".$cdata['zipcd'].")',";
		...
		for($i=0;$i<$nheader;$i++){
			...
			$pdf->SetFont('Sandy','',9);
			$pdf->SetXY($x_biodata, $y_biodata);
			$pdf->SetX($x_biodata);$pdf->MultiCell(50, 5, $cdata['custname2'], 0, 'L', 0, 1);$tmp_excel_bri_corp3.="(E'".addslashes(trim($header['cdname'][$i])).' - '.$cdata['custname2']."',";
			...
			for($x=0;$x<$ndetail;$x++){
				...
				$tmp_excel_bri_corp3 .="'".$detail['dtbuku'][$i][$x]."',";
				$tmp_excel_bri_corp3 .="E'".addslashes($detail['trans'][$i][$x]).$detail['forexcurr'][$i][$x]."',";
