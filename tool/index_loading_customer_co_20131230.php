								...
								<div id='div_form_load'>
									<form method="post" enctype="multipart/form-data" id="form_upload_customer" name="form_upload_customer" onsubmit="return cekForm()">
										...
										<table width="80%" border="0" cellpadding="2" cellspacing="2" align="center">
											...
											<tr>
												<td align="center" valign="middle" height="30" colspan="2" style="color:RED">
                                                	<b><blink>Khusus untuk BRI Corporate Card, tambahkan alamat email PIC BRI untuk semua customer! Alamat email tersebut adalah: </blink><em>stevi.marcelinus@corp.bri.co.id</em><blink> dan </blink><em>dbs.creditcard@corp.bri.co.id</em></b>
                                                </td>
											</tr>
											<tr>
