		...
		while($row = pg_fetch_array($qry)){
			...
			{ 
				...
				*/
				...
				$html = '<span style="text-align:justify;">Dengan ini kami informasikan bahwa kerjasama penerbitan Kartu Kredit Cobranding antara Bank BRI dan Bank Nusantara Parahyangan telah berakhir. Demi memberikan keamanan dan kenyamanan kepada Bapak/Ibu, bersama ini kami sampaikan bahwa Kartu Kredit Cobranding BNP Bapak/Ibu dengan rincian:</span>';
				// output the HTML content
				$pdf->writeHTML($html, true, 0, true, true);
