    ...
    <script>
		...
		function show_antrian(){
			...
			if(jml_record == ""){
				...
				$("#div_filter").hide(500);
				$("#div_show").show(500);
				Loaddiv('div_show','script_lihat_antrian.php','act=show_antrian&blth='+blth+'&flagtrans='+flagtrans+'&nama_file='+nama_file+'&tipe_jadwal='+tipe_jadwal+'&jml_record='+jml_record+'&offset=0');
			}
		}
		...
		function kirim_email(){
			...
			if(list_antrian!=''){
				var cek = confirm("Apakah Anda yakin akan mengirim antrian terpilih ?");
				if(cek){
		...
		function delete_all_antrian(){
			...
			if(list_antrian!=''){
				...
				if(cek){
					$("#div_show").html('<img src=../images/ajaxbig.gif>');
					$.post('script_lihat_antrian.php?act=delete_all_antrian&list='+list_antrian,'',function(respon_kirim){
						Loaddiv('div_show','script_lihat_antrian.php','act=show_antrian&blth='+blth+'&flagtrans='+flagtrans+'&nama_file='+nama_file+'&tipe_jadwal='+tipe_jadwal+'&jml_record='+jml_record+'&offset=0');
					});
				}
			}else{
