		...
		while(!feof($open_dat)){
			...
			if(trim($row_dat)!=''){
				...
				if ($regtype == '01')
				{
					...
					$url_pdf_jpg_summary = "../images/layout_summary.jpg";
					...
					$OLS_CUST_NBR 				= substr($row_dat,2,16);
					$OLS_PYMT_DUE_DATE 			= substr($row_dat,18,8);
					$OLS_CURR_BAL 				= substr($row_dat,26,14);
					$CR_LIMIT 					= substr($row_dat,41,14); #CREDIT LIMIT GABUNGAN
					$OLS_TOT_AMOUNT_DUE 		= substr($row_dat,56,14);
					$CR_CASH_LINE 				= substr($row_dat,71,14);
					$CR_AVAIL_CASH 				= substr($row_dat,86,14);
					...
					$arr_summary[$OLS_CUST_NBR]['header3'] = "$nama_cover_summary##$address1_cover_summary##$address2_cover_summary##$address3_cover_summary##$city_cover_summary##$zipcode_cover_summary##$text1_cover_summary";
				...
				if($regtype == '02'){
					...
					if (substr($no_card_dat,0,1) == "4") //VISA
					{
						...
						if ( substr($no_card_dat,0,8) == "46874001" || substr($no_card_dat,0,8) == "46874002") //Infinite - 20160419 Bowo
						{
							...
							$url_img = "../images/layout_infinite.jpg";
							$card_name="visa";
							$ket_produk="VISA";
							$yimage = 3.5;
							$y = 24;
						...
						elseif ( substr($no_card_dat,0,8) == "43597201" || substr($no_card_dat,0,8) == "43597202") //Hana bank - 20160727 Bowo
						{
							//$url_pdf = '';
...
$kolektibilitas = NULL;
									...
									if ( $regtype == '02' )
									{
										...
										if ( $flag_summary )
										{
											...
											$ket2 = add_page2_sumamry_jpg($pdf, $url_pdf_jpg_summary, $arr_summary, $jml_hlm); 
...
$dr_cr_indicator = NULL;
	...
	function add_page($pdf,
		...
		//$text1 = '"Nasabah Yth, terhitung tanggal 1 Juni 2017 suku bunga Kartu Kredit BRI turun dari 2.95% per bulan menjadi 2.25% per bulan. Tingkatkan terus Transaksi Anda dan Nikmati Bunga Ringan Kartu Kredit BRI."  Info penawaran menarik Kartu Kredit BRI di www.kartukredit.bri.co.id'; //20150531
		##$text1 = 'Yth Nasabah KK BRI, Per tgl 1 Nov 2017. Kami mengenakan biaya Rp.12.500/tagihan utk pengiriman lembar tagihan kertas. Segera daftar e-statement. Kirim SMS ke 3300 melalui no hp yg terdaftar di BRI Card Center dgn format : KKBRI(spasi)BS(spasi)6 digit awal no kartu#4 digit akhir no kartu#alamat email. Info Contact BRI 14017.'; //20170811
		//$text1 =   "Yth Nasabah KK BRI, Per tgl 01 Mei 2019. Kami mengenakan biaya Rp. 15.000,-/tagihan utk pengiriman lembar tagihan kertas. Segera daftar e-statement. Kirim SMS ke 3300 melalui no hp yg terdaftar di BRI Card Center dgn format : KKBRI(spasi)BS(spasi)6 digit awal no kartu#4 digit akhir no kartu#alamat email. Info Contact BRI 14017." ; //20170811
		$text1 =   "Yth. Nasabah KK BRI. Demi meningkatkan layanan, kami akan mengenakan biaya sms notifikasi transaksi sebesar Rp 5.000 per kartu mulai tanggal 1 September 2019. Informasi lebih lanjut hubungi Contact BRI 14017/1500017" ; //20190806
		...
		//$text2 = "Nasabah Kartu Kredit Gold BRI Anda dapat menikmati Executive Lounge BRI dengan menukarkan 250 BRI Point. Info Lebih Lanjut Hubungi Call BRI 14017";
		//$text3 = "Nasabah Kartu Kredit Platinum BRI, Mulai 1 Jan 2013 Anda dapat menikmati Executive Lounge BRI sebanyak 1 Pax.";
		//$text2 = "Nasabah Yth, dalam rangka meningkatkan layanan mulai 1 Februari 2016 Bunga Kartu Kredit BRI disesuaikan menjadi 2.50% per bulan.\nTerus gunakan dan nikmati berbagai penawaran istimewa dengan Kartu Kredit BRI.\nInfo Call BRI 14017";
		//$text2 = '"Nasabah Yth, terhitung tanggal 1 Juni 2017 suku bunga Kartu Kredit BRI turun dari 2.95% per bulan menjadi 2.25% per bulan. Tingkatkan terus Transaksi Anda dan Nikmati Bunga Ringan Kartu Kredit BRI."  Info penawaran menarik Kartu Kredit BRI di www.kartukredit.bri.co.id'; //20150531
		##$text2 = 'Yth Nasabah KK BRI, Per tgl 1 Nov 2017. Kami mengenakan biaya Rp.12.500/tagihan utk pengiriman lembar tagihan kertas. Segera daftar e-statement. Kirim SMS ke 3300 melalui no hp yg terdaftar di BRI Card Center dgn format : KKBRI(spasi)BS(spasi)6 digit awal no kartu#4 digit akhir no kartu#alamat email. Info Contact BRI 14017.'; //20170811
		#$text2 =   "Yth Nasabah KK BRI, Per tgl 01 Mei 2019. Kami mengenakan biaya Rp. 15.000,-/tagihan utk pengiriman lembar tagihan kertas. Segera daftar e-statement. Kirim SMS ke 3300 melalui no hp yg terdaftar di BRI Card Center dgn format : KKBRI(spasi)BS(spasi)6 digit awal no kartu#4 digit akhir no kartu#alamat email. Info Contact BRI 14017." ; //20170811
		$text2 =   "Yth. Nasabah KK BRI. Demi meningkatkan layanan, kami akan mengenakan biaya sms notifikasi transaksi sebesar Rp 5.000 per kartu mulai tanggal 1 September 2019. Informasi lebih lanjut hubungi Contact BRI 14017/1500017" ; //20190806
		
		//$text3 = "Nasabah Yth, dalam rangka meningkatkan layanan mulai 1 Februari 2016 Bunga Kartu Kredit BRI disesuaikan menjadi 2.95% per bulan.\nTerus gunakan dan nikmati berbagai penawaran istimewa dengan Kartu Kredit BRI.\nInfo Call BRI 14017";
		//$text3 = '"Nasabah Yth, terhitung tanggal 1 Juni 2017 suku bunga Kartu Kredit BRI turun dari 2.95% per bulan menjadi 2.25% per bulan. Tingkatkan terus Transaksi Anda dan Nikmati Bunga Ringan Kartu Kredit BRI."  Info penawaran menarik Kartu Kredit BRI di www.kartukredit.bri.co.id'; //20150531
		##$text3 = 'Yth Nasabah KK BRI, Per tgl 1 Nov 2017. Kami mengenakan biaya Rp.12.500/tagihan utk pengiriman lembar tagihan kertas. Segera daftar e-statement. Kirim SMS ke 3300 melalui no hp yg terdaftar di BRI Card Center dgn format : KKBRI(spasi)BS(spasi)6 digit awal no kartu#4 digit akhir no kartu#alamat email. Info Contact BRI 14017.'; //20170811
		#$text3 =   "Yth Nasabah KK BRI, Per tgl 01 Mei 2019. Kami mengenakan biaya Rp. 15.000,-/tagihan utk pengiriman lembar tagihan kertas. Segera daftar e-statement. Kirim SMS ke 3300 melalui no hp yg terdaftar di BRI Card Center dgn format : KKBRI(spasi)BS(spasi)6 digit awal no kartu#4 digit akhir no kartu#alamat email. Info Contact BRI 14017." ; //20170811
		$text3 =   "Yth. Nasabah KK BRI. Demi meningkatkan layanan, kami akan mengenakan biaya sms notifikasi transaksi sebesar Rp 5.000 per kartu mulai tanggal 1 September 2019. Informasi lebih lanjut hubungi Contact BRI 14017/1500017" ; //20190806
		
		//$text4 = "Terus gunakan dan nikmati berbagai penawaran istimewa dengan Kartu Kredit BRI BRI JCB Platinum. Info Contact BRI 14017 / 1500017.";
		//$text4 = '"Nasabah Yth, terhitung tanggal 1 Juni 2017 suku bunga Kartu Kredit BRI turun dari 2.95% per bulan menjadi 2.25% per bulan. Tingkatkan terus Transaksi Anda dan Nikmati Bunga Ringan Kartu Kredit BRI."  Info penawaran menarik Kartu Kredit BRI di www.kartukredit.bri.co.id'; //20150531
		##$text4 = 'Yth Nasabah KK BRI, Per tgl 1 Nov 2017. Kami mengenakan biaya Rp.12.500/tagihan utk pengiriman lembar tagihan kertas. Segera daftar e-statement. Kirim SMS ke 3300 melalui no hp yg terdaftar di BRI Card Center dgn format : KKBRI(spasi)BS(spasi)6 digit awal no kartu#4 digit akhir no kartu#alamat email. Info Contact BRI 14017.'; //20170811
		#$text4 =   "Yth Nasabah KK BRI, Per tgl 01 Mei 2019. Kami mengenakan biaya Rp. 15.000,-/tagihan utk pengiriman lembar tagihan kertas. Segera daftar e-statement. Kirim SMS ke 3300 melalui no hp yg terdaftar di BRI Card Center dgn format : KKBRI(spasi)BS(spasi)6 digit awal no kartu#4 digit akhir no kartu#alamat email. Info Contact BRI 14017." ; //20170811
		$text4 =   "Yth. Nasabah KK BRI. Demi meningkatkan layanan, kami akan mengenakan biaya sms notifikasi transaksi sebesar Rp 5.000 per kartu mulai tanggal 1 September 2019. Informasi lebih lanjut hubungi Contact BRI 14017/1500017" ; //20190806
		...
		{
			//$message_atas ='';
			$message_atas =$text1; //20170531
		}
		else if (substr($kodekartu_2,0,6) == "435965") //HANA BANK
		{
			//$message_atas =''; 
			$message_atas =$text1; //20170531
		}
		...
		$pdf->Cell(20,5,'Halaman: '.$halaman_cetak_kertas.' / '.$jml_hlm);
	...
	function add_page2_sumamry_jpg($pdf, $url_pdf='', $arr_summary, $jml_hlm)
	{
		...
		if ( !empty($url_pdf) )
		{
			...
			$pdf->SetFont('BRICARD02','',9);
			#####$pdf->Cell(20,5,'Halaman: '.$hlm.' / '.$jml_hlm);
			$pdf->Cell(20,5,'Halaman: 1 / '.$jml_hlm);
		
			$var_summary_jeda = 22;
			$x_kanan_ujung=100;
			$x_kolom['atas']				= array(28, 75, 120, 160);
			$x_kolom['atas_x']				= array('n', 'n', 'y', 'y');
			$x_kolom['bawah']				= array(32, 75, 120, 160);
			$x_kolom['bawah_x']				= array('n', 'y', 'y', 'y');
			
			$x_kolom['footer']				= array(23, 66, $x_kanan_ujung-(2*$var_summary_jeda), $x_kanan_ujung-(1*$var_summary_jeda), $x_kanan_ujung);
			$x_kolom['footer_x']			= array('n', 'n', 'y', 'y', 'y');
				...
				foreach ($value as $key2 => $value2) 
				{
					...
					if ( $key2 == 'header1' || $key2 == 'header2' )
					{
						...
						for($x_tambahan=0;$x_tambahan<=count($arr_isi);$x_tambahan++)
						{
							...
							{
								$pdf->SetXY(25+93,85);
								$pdf->MultiCell(70,4,$arr_isi[$x_tambahan],0,'C');
							}else{
								$pdf->SetXY(25,90+(4*$x_tambahan));
								$pdf->SetFont('BRICARD02','',9);
								$pdf->Cell(67,4,$arr_isi[$x_tambahan],0,0,'L');
							}
						...
						$summary_footer = number_format((int)$arr_isi[0],0,'',',');
					}else{
						for($x_tambahan=0;$x_tambahan<=count($arr_isi);$x_tambahan++)
						{
								...
								$pdf->SetXY($x_kolom['footer'][$x_tambahan],180+(5*$f)-$var_y_summary);
								$pdf->SetFont('BRICARD02','',9);
						...
						$f++;
							...
							$f++;
							$pdf->SetXY($x_kolom['footer'][4]+35,180+(5*$f)-$var_y_summary);
							$pdf->SetFont('BRICARD02','',9);
							$pdf->Cell(67,4,'Sisa Limit Gabungan',0,0,'L');
							
							
							$pdf->SetXY($x_kolom['footer'][4]+$var_summary_jeda,180+(5*$f)-$var_y_summary);
							$pdf->SetFont('BRICARD02','',9);
							...
							$f = $f+3;
							$pdf->SetXY($x_kolom['footer'][0],180+(5*$f)-$var_y_summary);
							$pdf->SetFont('BRICARD02','',9);
							$pdf->Cell(67,4,'Total Tagihan Bulan ini',0,0,'L');
							
							
							$pdf->SetXY($x_kolom['footer'][3],180+(5*$f)-$var_y_summary);
							$pdf->SetFont('BRICARD02','',9);
							$pdf->Cell(67,4, number_format($total_tagihan_1,0,'',','),0,0,'R');
							
							
							$pdf->SetXY($x_kolom['footer'][4],180+(5*$f)-$var_y_summary);
							$pdf->SetFont('BRICARD02','',9);
							$pdf->Cell(67,4, number_format($total_tagihan_2,0,'',','),0,0,'R');
			///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
