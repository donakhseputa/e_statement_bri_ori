...
<script>
	...
	Loaddiv('div_blth','script_lihat_antrian_sk.php','act=blth&flagtrans='+flagtrans+'&blth_home='+blth_home);
	$("#checkbox_nama_file").removeAttr('disabled');
	$("#checkbox_nama_file").attr("checked","checked");
	Loaddiv('span_nama_file_rec','script_lihat_antrian_sk.php','act=show_nama_file_rec&flagtrans='+flagtrans+'&blth='+blth_home+'&nama_file=<?php echo $row_ml['loading_file'];?>');
	Loaddiv('span_blth_record','script_lihat_antrian_sk.php','act=show_blth_rec&flagtrans='+flagtrans+'&blth='+blth_home);
	Loaddiv('div_nama_file','script_lihat_antrian_sk.php','act=show_nama_file&flagtrans='+flagtrans+'&blth='+blth_home+'&mloading_home='+<?php echo $mloading_home;?>);
	Loaddiv('div_show','script_lihat_antrian_sk.php','act=show_antrian&menu_id='+<?php echo $menu_id;?>+'&blth='+blth_home+'&flagtrans='+flagtrans+'&nama_file=<?php echo $row_ml['loading_file'];?>&tipe_jadwal=1&jml_record=50&offset=0');
