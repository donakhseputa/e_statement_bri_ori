...
$kolektibilitas = NULL;
									...
									$pdf->SetXY($x+68-22,$y_detail+$y_traveloka_tambahan);
									$pdf->SetFont('BRICARD02','',7.12);
...
$dr_cr_indicator = NULL;
	...
	function add_page($pdf,
		...
		*/
		...
		$x_barcode = $x+1+4;
		$y_barcode = $y+76-9+2;
		$pdf->SetXY($x_barcode,$y_barcode-5-3);
		#$pdf->SetFont('C39P24DhTt','',45);
		$pdf->SetFont('C39P24DhTt','',62);
		$pdf->Cell(70,4,$barcode,0,1,'L');
		
		
		$pdf->SetFillColor(255,255,255);
		$pdf->Rect($x_barcode,$y_barcode-17,53,5.5+11,'F');
		...
		$text2 =   "Yth. Nasabah KK BRI. Sesuai dgn Surat Edaran Bank Indonesia No. 16/25/DSKP tgl 31-12-2014, mulai tgl 01-07-2020 pemegang kartu kredit WAJIB menggunakan PIN 6 digit sebagai sarana verifikasi & autentikasi transaksi. Info Contact BRI 14017/1500017" ; //20191015
		...
		$text3 =   "Yth. Nasabah KK BRI. Sesuai dgn Surat Edaran Bank Indonesia No. 16/25/DSKP tgl 31-12-2014, mulai tgl 01-07-2020 pemegang kartu kredit WAJIB menggunakan PIN 6 digit sebagai sarana verifikasi & autentikasi transaksi. Info Contact BRI 14017/1500017" ; //20191015
		...
		$text4 =   "Yth. Nasabah KK BRI. Sesuai dgn Surat Edaran Bank Indonesia No. 16/25/DSKP tgl 31-12-2014, mulai tgl 01-07-2020 pemegang kartu kredit WAJIB menggunakan PIN 6 digit sebagai sarana verifikasi & autentikasi transaksi. Info Contact BRI 14017/1500017" ; //20191015
		
		
		$text_hana =   "Yth. Nasabah KEB Hana. Sesuai dgn Surat Edaran Bank Indonesia No. 16/25/DSKP tgl 31-12-2014, mulai tgl 01-07-2020 pemegang kartu kredit WAJIB menggunakan PIN 6 digit sebagai sarana verifikasi & autentikasi transaksi. Info Contact BRI 14017/1500017" ; //20191015
		$text_agro =   "Yth. Nasabah KK BRI Agro. Sesuai dgn Surat Edaran Bank Indonesia No. 16/25/DSKP tgl 31-12-2014, mulai tgl 01-07-2020 pemegang kartu kredit WAJIB menggunakan PIN 6 digit sebagai sarana verifikasi & autentikasi transaksi. Info Contact BRI 14017/1500017" ; //20191015
				...
				foreach ($value as $key2 => $value2) 
				{
					...
					if ( $key2 == 'header1' || $key2 == 'header2' )
					{
						...
						/////////////////////////////////////////////////////////////////////////////////////
								...
								$x_barcode = 23;
								$y_barcode =95;
								$pdf->SetXY($x_barcode,$y_barcode-8);
								$pdf->SetFont('C39P24DhTt','',62);
								$pdf->Cell(70,4,$barcode,0,1,'L');
