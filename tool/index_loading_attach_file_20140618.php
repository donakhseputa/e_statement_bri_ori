...
echo "Total " .$jumData;
	...
	$sql .= " WHERE flagtrans = '$flag'";
	$sql .= " ORDER BY m_attach_file_id DESC";
	$sql .= " LIMIT $dataPerPage OFFSET $offset";
...
?>
										<tr class="table_row_odd">
											...
											<td height="30" align="center" valign="middle"><?= $row["blth"] ?></td>
											<td align="left" valign="middle">
										 <? echo "<a href= '".$row['location_file'] . $row["name_file"].  " ' >". $row['name_file'] ."</a>"; ?>
                                            ...
                                            <?= number_format($row["ukuran"] /1024) . "&nbsp" ?> </td>
											<td align="left" valign="middle"><?= $row["userid"] ?></td>
											<td align="left" valign="middle"><?= 
											date('Y-m-d H:i',strtotime($row['modify_date']))?></td>
										</tr>
<?
	$i++;
	}
