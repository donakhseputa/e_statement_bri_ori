		...
		function upload_customer(val,flag){
			if(flag=='BC'){
				$.post("script_loading_customer_bc.php",{pr:val},function(respon){
					...
					$("#div_message").html("-- Jumlah Record = " + jml_record + " record --<br /><br />record yang sudah pernah di-loading:<br />" + record_exists + "<br /><br />-- Total waktu impor data = " + menit + " menit " + detik + " detik --");
