...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script>
		function upload_detail(val,flag,rad_cust, file_php){
			...
			//alert(val);return false;
					//$.post("script_loading_detail_pk_excel.php",{pr:val},function(respon){
    ...
    <?php
		...
		if ( preg_match("/adhoc/i", $file) )
		{
			#$file_php = "script_loading_detail_pk_excel_adhoc2.php";
			
			
			if ( preg_match("/adhoc_bnp_/i", $file) )
			{
				$file_php = "script_loading_detail_pk_excel_adhoc2_bnp.php";
			}else{
				#$file_php = "script_loading_detail_pk_excel_adhoc2.php";
				
				if ( preg_match("/adhoc_pbk_v2_/i", $file) )
				{
					$file_php = "script_loading_detail_pk_excel_adhoc2_v2.php";
				}else if ( preg_match("/adhoc_12bln_/i", $file) )
				{
					$file_php = "script_loading_detail_pk_excel_adhoc2.php";
				}else{
					$file_php = "script_loading_detail_pk_excel_adhoc.php";
				}
			...
			$file_php = "script_loading_detail_pk_excel.php";
		}
