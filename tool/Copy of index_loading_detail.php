...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script>
		...
		function show_det(m_loading_id){
			...
			Loaddiv('div_detail','script_loading_detail.php','act=show_detail&m_loading_id='+m_loading_id+'&offset=0&input_search='+input_search);
                                        ...
                                        <tr>
                                            ...
                                            <td width="15%">
                                                <select id="blth" name="blth" class="combobox" onchange="showRecord()">
                                                   <option value="<?=GetBLTH(date('mY'),-2)?>"><?=GetBLTH(date('mY'),-2)?></option>
