			...
			if($status_pdf == "Y"){
				...
				if(pg_affected_rows($qry_ins_tr_email)>0){
					...
					if(isset($tr_email_id)){
						...
						$img_mail = '<img src="http://www.e-statement.net/e_statement/bri/emailConfirm.php?client=BRI&flagtrans='.$flagtrans.'&tr_email_id='.$tr_email_id.'&email='.$email.'" border="0" height="1" width="1"></script>';
