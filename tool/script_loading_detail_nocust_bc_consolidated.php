...
$kolektibilitas = NULL;
									...
									$prev_bonus = substr($row_dat,(524+$var_cover),6);
									$earned_bonus = substr($row_dat,(534+$var_cover),6);
									$point_bonus = substr($row_dat,(544+$var_cover),6);
									$redeemed_bonus = substr($row_dat,(554+$var_cover),6);
									$adjusment_bonus = substr($row_dat,(564+$var_cover),6);
									$point_avail = substr($row_dat,(574+$var_cover),6);
...
$dr_cr_indicator = NULL;
	...
	function add_page($pdf,
		...
		*/
		...
		/*
		$text1_cover_summary_old = "Yth Nasabah Kartu Kredit BRI, untuk kelancaran anda dalam bertransaksi pastikan alamat pengiriman Kartu Kredit BRI anda sudah benar dan lengkap. Apabila ada perubahan alamat mohon dapat dilakukan pengkinian data melalui : "."\n"."1. BRICC Mobile (dapat didownload melalui Appstore / Playstore)"."\n"."2. Info Contact BRI 14017 /1500017" ; //20210319
		...
		$text_traveloka = $text1_cover_summary_old;
		...
		if ( substr($kodekartu,0,8) == "43650204" ) //BRI Pegadaian - 20201123
		{
			$message_atas = 'Tagihan kartu emas Anda di lembar tagihan ini ditambah dengan transaksi  Anda s.d. tanggal 15 bulan ini akan dikonversikan menjadi GTE. Pembayaran GTE dapat dilakukan melalui menu Bayar Gadai Pegadaian Digital'; //20211221
		}
		
		if ( substr($kodekartu,0,8) == "43597201" || substr($kodekartu,0,8) == "43597202") //Hana bank Platinum - 20160727 Bowo --> telah berubah menjadi tokopedia 20211125
		{
			$message_atas = "Yth Nasabah Kartu Kredit BRI, untuk kelancaran anda dalam bertransaksi pastikan alamat pengiriman Kartu Kredit BRI anda sudah benar dan lengkap. Apabila ada perubahan alamat mohon dapat dilakukan pengkinian data melalui : "."\n"."Info Contact BRI 14017 / 1500017" ; //20210319
		}
		*/
		...
		/*
					...
					else if ( substr($kodekartu,0,8) == "43597201" || substr($kodekartu,0,8) == "43597202") // tokopedia 20211125
					{
						$message_atas = "Yth Nasabah Kartu Kredit BRI, untuk kelancaran anda dalam bertransaksi pastikan alamat pengiriman Kartu Kredit BRI anda sudah benar dan lengkap. Apabila ada perubahan alamat mohon dapat dilakukan pengkinian data melalui : "."\n"."Info Contact BRI 14017 / 1500017" ; //20210319
					}
					else if ( substr($kodekartu,0,8) == "55200233" ) //OVO
					{
						$message_atas = "Yth Nasabah Kartu Kredit BRI, untuk kelancaran anda dalam bertransaksi pastikan alamat pengiriman Kartu Kredit BRI anda sudah benar dan lengkap. Apabila ada perubahan alamat mohon dapat dilakukan pengkinian data melalui : "."\n"."1. BRICC Mobile (dapat didownload melalui Appstore / Playstore)"."\n"."2. Info Contact BRI 14017 /1500017" ; //20210319
					}
					else if ( substr($kodekartu,0,8) == "43650203" ) //Traveloka
					{
						$message_atas = "Yth Nasabah Kartu Kredit BRI, untuk kelancaran anda dalam bertransaksi pastikan alamat pengiriman Kartu Kredit BRI anda sudah benar dan lengkap. Apabila ada perubahan alamat mohon dapat dilakukan pengkinian data melalui : "."\n"."1. BRICC Mobile (dapat didownload melalui Appstore / Playstore)"."\n"."2. Info Contact BRI 14017 /1500017" ; //20210319
					}
					else if ( substr($kodekartu,0,8) == "43596501" || substr($kodekartu,0,8) == "43596502" ) //BTN
					{
						$message_atas = "Yth Nasabah Kartu Kredit BRI, untuk kelancaran anda dalam bertransaksi pastikan alamat pengiriman Kartu Kredit BRI anda sudah benar dan lengkap. Apabila ada perubahan alamat mohon dapat dilakukan pengkinian data melalui : "."\n"."1. BRICC Mobile (dapat didownload melalui Appstore / Playstore)"."\n"."2. Info Contact BRI 14017 /1500017" ; //20210319
					}else{
						$message_atas = "Yth Nasabah Kartu Kredit BRI, untuk keamanan & kenyamanan transaksi Kartu Kredit BRI anda, notifikasi transaksi via SMS dengan nominal kurang dari Rp.500 ribu dinonaktifkan per 15 September 2022. Untuk keamanan & kenyamanan transaksi, segera daftarkan alamat email anda dan download aplikasi BRICC Mobile melalui App Store & Play Store agar mendapatkan fitur push notification transaksi."."\n" ; //20220811
					}
					*/
		///////////////////////////////////////////////////////////////////// PESAN KOTAK NON SUMMARY ///////////////////////////////////////////
		///////////////////////////////////////////////////////////////////// PESAN KOTAK NON SUMMARY ///////////////////////////////////////////
