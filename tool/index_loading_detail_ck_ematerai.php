    ...
    <script>
		...
		function cekForm(){
			...
			if(confirm('Untuk menghindari kesalahan loading, tolong dicek kembali!\n\nApakah Anda ingin melanjutkan?')){
				if(product=='CO'){
					$("#form_upload_detail").attr('action','proses_loading_detail_co_ematerai.php?pr='+pr+'|dat_to_pdf');
		...
		function download_sip(m_loading_id){
			window.open('script_loading_detail.php?act=download_sip&m_loading_id='+m_loading_id);
		}
                                        	...
                                        	<td colspan="3" align="left">
                                            	<table>
                                                    <tr>
                                                        <td height="30">
                                                        	<label>
                                                        	<input type="radio" name="rad_cust" id="rad_cust1" value="1" disabled="disabled" />
                                                        ...
                                                        <td height="30">
                                                        	<label>
                                                        	<input type="radio" name="rad_cust" id="rad_cust2" value="2" checked="checked" />
