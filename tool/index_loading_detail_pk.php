		...
		*/
		...
		function cekForm(){
			...
			if(confirm('Untuk menghindari kesalahan loading, tolong dicek kembali!\n\nApakah Anda ingin melanjutkan?')){
				if(product=='PK'){
					$("#form_upload_detail").attr('action','proses_loading_detail_pk.php?pr='+pr+'|excel_to_pdf');
				}else{
		...
		function showRecord(){
			...
			if(product=='PK'){
				...
				$.post("script_loading_detail_pk_excel.php",{pr:pr+'|show_record|'+blth},function(respon){
				...
				//$.post("script_loading_detail_pk_excel.php",{pr:pr+'|show_file_mcustomer|'+blth},function(respon){
                                ...
                                <form method="post" enctype="multipart/form-data" id="form_upload_detail" name="form_upload_detail" onsubmit="return cekForm()">
                                    ...
                                    <table width="80%" border="0" cellpadding="2" cellspacing="2" align="center">
										<tr>
											...
											Reguler : <b>SURAT_TUTUP_KARTU_06MEI2019TE.XLSX</b> /  <b>SURAT_TUTUP_KARTU_06MEI2019DE.XLSX</b><br>
											Reguler : <b>SURAT_TUTUP_KARTU_DAN_SURAT_LUNAS_06MEI2019TE.XLSX</b> / <b>SURAT_TUTUP_KARTU_DAN_SURAT_LUNAS_06MEI2019DE.XLSX</b><br>
											<br>
											PBK : <b>STKP_ADHOC_PBK8_8MAR2019_DE.XLSX</b> / <b>STKP_ADHOC_PBK8_8MAR2019_TE.XLSX</b><br>
											<br>
											PBK : <b>STKP_ADHOC_PBK_V2_8MAR2019_DE.XLSX</b> (PBK TEMPLATE BARU VERSI 2)<br>
											<br>
											BNP : <b>STK_ADHOC_BNP_1_27FEB2019DE.XLSX</b> / <b>STKl_ADHOC_BNP_1_27FEB2019TE.XLSX</b><br>
											<br>
											<br>
