    ...
    <script>
		...
		function oncheck_file(){
			if($("#checkbox_nama_file").attr('checked')==true){
				...
				Loaddiv('div_file_customer','script_kirim_antrian.php','act=file_customer&blth='+blth+'&flagtrans=<?=$flagtrans?>');
			}else{
				$("#file_cust").val('');
				$("#file_cust").attr('disabled','disabled');
				$("#nama_file").val('');
		...
		function oncheck_norek(){
			if($("#checkbox_norek").attr('checked')==true){
				...
				Loaddiv('div_norek','script_kirim_antrian.php','flagtrans=<?=$flagtrans?>&act=norek&blth='+blth+'&file='+nama_file);
			}else{
				$("#norek").val('');
				$("#norek").attr('disabled','disabled');
				clear_sample();
		...
		function email(){
			...
			if(norek=='' || $("#checkbox_norek").attr('checked')==false){
				...
				Loaddiv('email_address','script_kirim_antrian.php','flagtrans=<?=$flagtrans?>&act=email&blth='+blth+'&nama_file='+nama_file+'&norek='+norek);
			}
			show_sample();
		}
