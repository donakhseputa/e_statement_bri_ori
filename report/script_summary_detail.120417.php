                    	...
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
                            	<tr height="30">
                                	...
                                	<td align="center"><b>Email Belum Kirim</b></td>
                                ...
                                <?php
									...
									$sql_data = "SELECT
														...
														(SELECT count(distinct(email))
															FROM vw_email
															WHERE blth = '$blth' and flagtrans = '$flagtrans' and m_loading_id=a.m_loading_id) AS jml_email,
														(SELECT count(*)
															FROM antrian_email x INNER JOIN m_loading y ON x.loading_id = y.m_loading_id 
															WHERE blth = '$blth' and flagtrans = '$flagtrans' and loading_id=a.m_loading_id) as jml_blm_kirim,
														(SELECT count(*)
															FROM tr_email x INNER JOIN m_loading y ON x.loading_id = y.m_loading_id 
															JOIN vw_email z ON x.loading_id = z.m_loading_id and x.email = z.email
															WHERE y.blth = '$blth' and y.flagtrans = '$flagtrans' and x.date_email_callback is null and 
																x.email_sukses = TRUE AND x.loading_id=a.m_loading_id) as email_sukses,
														(select count(*)
															FROM tr_email x INNER JOIN m_loading y ON x.loading_id = y.m_loading_id 
															WHERE y.blth = '$blth' and y.flagtrans = '$flagtrans' and x.date_email_callback is not null and 
																x.loading_id=a.m_loading_id) as email_gagal
													FROM m_loading a
														INNER JOIN detail b
															ON a.m_loading_id = b.m_loading_id
													WHERE a.blth = '$blth' and a.flagtrans = '$flagtrans'
													group by a.create_date, a.loading_file, a.m_loading_id, a.total_customer, a.total_halaman";
									//echo "$sql_data<br>";
                                ...
                                <tr height="30">
                                	...
                                	<td align="right"><?php echo number_format($row_data['jml_pdf'],0,',','')?>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($row_data['jml_lembar'],0,',','')?>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($row_data['jml_email'],0,',','')?>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($row_data['jml_blm_kirim'],0,',','')?>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($row_data['email_sukses'],0,',','')?>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($row_data['email_gagal'],0,',','')?>&nbsp;&nbsp;</td>
                                </tr>
                                <?php
									}
								?>
