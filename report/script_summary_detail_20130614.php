...
<?
	...
	if($_REQUEST['xls']=='y') HeaderingExcel("Ekspor_Excel.xls");
	...
	switch($act){
		...
		case 'show_list_pdf': show_list_pdf(); break;
		case 'show_list_email': show_list_email(); break;
		case 'show_list_antrian': show_list_antrian(); break;
		case 'show_email_sukses': show_email_sukses(); break;
		case 'show_email_gagal': show_email_gagal(); break;
		case 'show_email_terbaca': show_email_terbaca(); break;
		case 'show_email_sample_sukses': show_email_sample_sukses(); break;
		case 'show_email_sample_gagal': show_email_sample_gagal(); break;
                    	...
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
                            	<tr height="30">
									...
									<td align="center"><b>Email Terbaca</b></td>
                                	<td align="center"><b>Sample Sukses</b></td>
                                	<td align="center"><b>Sample Gagal</b></td>
                                </tr>
                                <?php
									if (!empty($cycle)){
									...
									$sql_data = "
										...
										FROM m_loading a
											...
											LEFT JOIN (
												SELECT count(*) as jml_email, m_loading_id
												FROM vw_email
											...
											LEFT JOIN (SELECT
													   count(*)          as email_sukses,   loading_id
													 FROM tr_email a
													   LEFT JOIN vw_email b
														 ON a.loading_id = b.m_loading_id
														   and a.nomor_rekening = b.nomor_rekening   and a.email = b.email
											...
											LEFT JOIN (
												...
												FROM tr_email a
													LEFT JOIN vw_email b
														ON a.loading_id = b.m_loading_id and a.nomor_rekening = b.nomor_rekening and a.email = b.email
										...
										GROUP BY a.m_loading_id, to_char(a.create_date,'yyyy-mm-dd HH24:MI'), a.loading_file, a.total_customer, a.total_halaman,
											c.jml_email, d.jml_antrian, e.email_sukses, f.email_gagal, et.email_terbaca, g.sample_sukses, h.sample_gagal
									...
									<tr height="30">
										...
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_pdf&m_loading_id=<?php echo $m_loading_id?>')"><?php echo number_format($row_data['jml_pdf'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_pdf&m_loading_id=<?php echo $m_loading_id?>')"><?php echo number_format($row_data['jml_lembar'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_email&m_loading_id=<?php echo $m_loading_id?>')"><?php echo number_format($row_data['jml_email'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_antrian&m_loading_id=<?php echo $m_loading_id?>')"><?php echo number_format($row_data['jml_antrian'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_email_sukses&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['email_sukses'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_email_gagal&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['email_gagal'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_email_terbaca&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['email_terbaca'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_email_sample_sukses&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['sample_sukses'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_email_sample_gagal&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['sample_gagal'],0,'',',')?></a>&nbsp;&nbsp;</td>
									</tr>
									<?php
                                ...
                                <tr height="30" style="font-weight:bold">
                                	...
                                	<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_pdf&blth=<?php echo $blth?>')"><?php echo number_format($total_pdf,0,'',',')?></a>&nbsp;&nbsp;
                                    </td>
                                	<td align="right"><?php echo number_format($total_lembar,0,'',',')?>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($total_email,0,'',',')?>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($total_antrian,0,'',',')?>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($total_e_sukses,0,'',',')?>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($total_e_gagal,0,'',',')?>&nbsp;&nbsp;</td>
									<td align="right"><?php echo number_format($total_e_terbaca,0,'',',')?>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($total_s_sukses,0,'',',')?>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($total_s_gagal,0,'',',')?>&nbsp;&nbsp;</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
	...
	function show_list_pdf(){
		$m_loading_id = $_REQUEST['m_loading_id'];
		$blth  = $_REQUEST['blth'];
		
		$sql = "SELECT loading_file FROM m_loading ";
		
		if ($blth == "")
		{ 
		$where = " WHERE m_loading_id = $m_loading_id";
		}
		else
		{
		$where .= " WHERE blth = '$blth' ";
		}
                	...
                	<tr>
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <tr height="30">
                                	<td><b>Nama File: <?=$nama_file?></b></td>
                                    <td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_pdf&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    	...
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
                            	<tr height="30" bgcolor="#FF0000" style="color:#FFF">
                                	<td width="4%" align="center"><b>No</b></td>
                                	<td align="center"><b>Nomor Customer</b></td>
                                ...
                                <?php
									$i = 0;
									$sql_data = "
										SELECT flagtrans, blth, nomor_customer, nama, pdf_name, password_pdf, jml_hlm, nama_file, 
										nomor_rekening
										FROM detail
										";
									$sql_data = $sql_data .$where . " ORDER BY m_loading_id, nomor_rekening ASC";
                                ...
                                <tr height="30">
                                	<td align="center"><?php echo $i?></td>
                                	<td align="center"><?php echo $row_data['nomor_customer']?></td>
                                	<td align="center"><?php echo $row_data['nomor_rekening']?></td>
                                	<td align="center"><?php echo $row_data['nama']?></td>
                                	<td align="center"><?php
									$pdf_location = "../pdf/".$row_data['blth']."/".str_replace(substr($nama_file,-4),"",$nama_file)."/";?>
                	...
                	<tr>
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <tr height="30">
                                	<td><b>Nama File: <?=$nama_file?></b></td>
                                    <td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_email&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    	...
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <?php
									$i = 0;
									$sql_data = "
										SELECT nomor_rekening, nama, email
										FROM vw_email
                	...
                	<tr>
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <tr height="30">
                                	<td><b>Nama File: <?=$nama_file?></b></td>
                                    <td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_antrian&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
								...
								$i = 0;
								$sql_data = "
									SELECT a.nomor_customer, a.nomor_rekening, a.nama, a.email, a.pdf_name,
										CASE
									...
									WHERE a.loading_id = $m_loading_id
									ORDER BY a.nomor_customer, a.nomor_rekening, a.nama, a.email, a.pdf_name
								";
								$qry_data = pg_query($sql_data) or die('ERROR select data: '.$sql_data);
								while($row_data = pg_fetch_array($qry_data)){
									$i++;
                	...
                	<tr>
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <tr height="30">
                                	<td><b>Nama File: <?=$nama_file?></b></td>
                                    <td align="right"><a onClick="window.open('script_summary_detail.php?act=show_email_sukses&m_loading_id=<?php echo $m_loading_id?>&xls=y<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
								...
								$i = 0;
								$sql_data = "
									SELECT distinct a.antrian_id, a.email, b.nama,
										b.nomor_rekening,
									...
									WHERE a.loading_id = b.m_loading_id
										...
										and b.m_loading_id = $m_loading_id AND status_sample is not true ".$pk_where."
									ORDER BY to_char(a.date_email_send,'DD-Mon-YYYY HH24:MI:SS'),b.nomor_rekening ASC
								";
								//echo $sql_data;
								$qry_data = pg_query($sql_data) or die('ERROR select data: '.$sql_data);
								while($row_data = pg_fetch_array($qry_data)){
                	...
                	<tr>
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <tr height="30">
                                	<td><b>Nama File: <?=$nama_file?></b></td>
                                    <td align="right"><a onClick="window.open('script_summary_detail.php?act=show_email_gagal&m_loading_id=<?php echo $m_loading_id?>&xls=y<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
								...
								$i = 0;
								$sql_data = "
									SELECT distinct a.antrian_id, a.email, a.ket_error,
                                ...
                                <tr height="30">
                                	...
                                	<td align="center"><?php echo $row_data['email']?></td>
                                	<td align="center"><?php echo $row_data['date_email_send']?></td>
                                	<td align="center"><?php echo $row_data['ket_error']?></td>
                                    <td align="center"><a onClick="view_template(<?=$antrian_id?>)"><img title="view template" src="../images/icons/icon_view.gif" /></a></td>
                                </tr>
                                <?php
									}
                	...
                	<tr>
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <tr height="30">
                                	<td><b>Nama File: <?=$nama_file?></b></td>
                                    <td align="right"><a onClick="window.open('script_summary_detail.php?act=show_email_terbaca&m_loading_id=<?php echo $m_loading_id?>&xls=y<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
								...
								$i = 0;
								$sql_data = "
									SELECT DISTINCT a.antrian_id, a.email, b.nama, b.nomor_rekening,a.waktu_read_email,
									  to_char(a.date_email_send,'DD-Mon-YYYY HH24:MI:SS') AS date_email_send,
									  to_char(a.waktu_read_email,'DD-Mon-YYYY HH24:MI:SS') AS waktu_read_email, a.read_email_id, a.body_email, a.keterangan
									FROM ((SELECT *
										FROM tr_email WHERE tgl_read IS NOT NULL)a1
										  JOIN read_email re	
											ON a1.tr_email_id = re.tr_email_id
									) a,
									  vw_email b
									WHERE a.loading_id = b.m_loading_id
										AND a.email = b.email
										...
										AND a.email_sukses = TRUE
										AND a.email_callback IS NULL
										AND b.m_loading_id = $m_loading_id
										AND status_sample IS NOT TRUE
										".$pk_where."
									ORDER BY a.waktu_read_email,b.nomor_rekening ASC
								";
								//echo $sql_data;
								$qry_data = pg_query($sql_data) or die('ERROR select data: '.$sql_data);
								while($row_data = pg_fetch_array($qry_data)){
                                ...
                                <tr height="30">
                                	...
                                	<td align="center"><?php echo $row_data['email']?></td>
                                	<td align="center"><?php echo $row_data['date_email_send']?></td>
									<td align="center"><?php echo $row_data['waktu_read_email']?></td>
									<td align="left"><?php echo $row_data['keterangan']?> -- 
                                        <?php
										if($_REQUEST['xls']=='y'){
	...
	function show_email_sample_sukses(){
		$m_loading_id = $_REQUEST['m_loading_id'];
		$per_send = explode('|', $_REQUEST['periode_kirim']);
		$sent_from = $per_send[0];
		$sent_to = $per_send[1];
                    ...
                    <tr>
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
								...
								$i = 0;
								$sql_data = "
									SELECT distinct a.antrian_id, a.email, c.nama, c.nomor_rekening, to_char(a.date_email_send,'DD-Mon-YYYY HH24:MI:SS') as date_email_send , loading_id
									FROM tr_email a
										LEFT JOIN vw_email b
											ON a.loading_id = b.m_loading_id and a.nomor_rekening = b.nomor_rekening and a.email = b.email
										LEFT JOIN (select * from detail where m_loading_id = $m_loading_id)c
											ON a.nomor_rekening = c.nomor_rekening
									WHERE date_email_callback is null 
									--and b.nomor_rekening is null
									and a.email_sukses = TRUE
									and status_sample is true 
									and a.loading_id = $m_loading_id AND status_sample is true ".$pk_where."
								";
								//echo $sql_data;
								$qry_data = pg_query($sql_data) or die('ERROR select data: '.$sql_data);
								while($row_data = pg_fetch_array($qry_data)){
	...
	function show_email_sample_gagal(){
		$m_loading_id = $_REQUEST['m_loading_id'];
		$per_send = explode('|', $_REQUEST['periode_kirim']);
		$sent_from = $per_send[0];
		$sent_to = $per_send[1];
                    ...
                    <tr>
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
								...
								$i = 0;
								$sql_data = "
									SELECT distinct a.antrian_id, a.email, c.nama, c.nomor_rekening, to_char(a.date_email_send,'DD-Mon-YYYY HH24:MI:SS') as date_email_send , loading_id, a.ket_error
									FROM tr_email a
										LEFT JOIN vw_email b
											ON a.loading_id = b.m_loading_id and a.nomor_rekening = b.nomor_rekening and a.email = b.email
										LEFT JOIN (select * from detail where m_loading_id = $m_loading_id)c
											ON a.nomor_rekening = c.nomor_rekening
									WHERE email_callback is not null 
									--and b.nomor_rekening is null
									and a.email_sukses = true
									and a.loading_id = $m_loading_id AND status_sample is true ".$pk_where."
								";
	...
	function load_template(){
		...
		//$pdf_location = "../pdf/".$flagtrans."/".$blth."/".str_replace(substr($nama_file,-4),"",$nama_file)."/";
		$pdf_location = "../pdf/".$blth."/".str_replace(substr($nama_file,-4),"",$nama_file)."/";
		...
		while($row_mail_server = pg_fetch_array($qry_sel_mail_server)){
			...
			for($i = 1; $i <= imap_num_msg($mbox); $i++){
				...
				if (strtoupper(substr($header_info->senderaddress, 0, 13)) == "MAILER-DAEMON") {
					cekBounce($mbox, $i, $header_info->senderaddress, $nama_file, $loading_id, $per_send);
					//imap_delete($mbox, $i);
				}else if(strtoupper(substr($header_info->subject, 0, 5)) == "READ:"){
					cekRead($mbox, $i, $header_info->in_reply_to, $nama_file, $loading_id, $per_send);
				}else if(strtoupper(substr($header_info->subject, 0, 9)) == "IMG EMAIL"){
					cekReadImg($mbox, $i, $header_info->senderaddress, $nama_file, $loading_id, $per_send);
				}/*else{
	...
	function cekRead($mbox, $i, $in_reply_to, $nama_file, $loading_id, $per_send){
		$sent_from = $per_send[0];
		$sent_to = $per_send[1];
		if (!empty($nama_file)){
			$w_cycle ="AND loading_id =".$loading_id."";
		...
		if($tgl_read != ''){
			$sql_sel = "SELECT * FROM tr_email WHERE tr_email_id = ".$in_reply_to;
			$sql_sel .= $w_cycle." ".$w_pkirim." ";
			$qry_sel = @pg_query($sql_sel);
			
			if(pg_num_rows($qry_sel) > 0){
	...
	function cekReadImg($mbox, $i, $header, $nama_file, $loading_id, $per_send){
		$sent_from = $per_send[0];
		$sent_to = $per_send[1];
		if (!empty($nama_file)){
			$w_cycle ="AND loading_id =".$loading_id."";
		...
		if(trim($email)<>''){
			$sql_sel = "SELECT * FROM tr_email WHERE tr_email_id = ".$tr_email_id;
			$sql_sel .= " and trim(email) = '".trim($email)."' ".$w_cycle." ".$w_pkirim." ";
			$qry_sel = @pg_query($sql_sel);
			...
			if(pg_num_rows($qry_sel) > 0){
				...
				if(pg_affected_rows($qry_ins)){
					...
					$sql .= " and trim(email) = '".trim($email)."' ".$w_cycle." ".$w_pkirim." ";
					$sql .= " AND tgl_read is null";
					$query = @pg_query($sql);
	...
	function export_excel($curloc, $locateFile) {
		...
		$objPHPExcel->getActiveSheet()->getStyle('A'.$y_post.':L'.$y_post.'')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB('ffdfdfdf');
		$styleArray = array(
		'borders' => array(
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('F'.$y_post.'',"Jumlah Email");
		$objPHPExcel->getActiveSheet()->SetCellValue('G'.$y_post.'',"Email di Antrian");
		$objPHPExcel->getActiveSheet()->SetCellValue('H'.$y_post.'',"Email Sukses");
		$objPHPExcel->getActiveSheet()->SetCellValue('I'.$y_post.'',"Email Gagal");
		$objPHPExcel->getActiveSheet()->SetCellValue('J'.$y_post.'',"Email Terbaca");
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('G'.$atrow.'',$row_data['jml_antrian']);
		$objPHPExcel->getActiveSheet()->SetCellValue('H'.$atrow.'',$row_data['email_sukses']);
		$objPHPExcel->getActiveSheet()->SetCellValue('I'.$atrow.'',$row_data['email_gagal']);
		$objPHPExcel->getActiveSheet()->SetCellValue('J'.$atrow.'',$row_data['email_terbaca']);
		...
		$objPHPExcel->getActiveSheet()->getStyle('A'.$atrow.':L'.$atrow.'')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB('fff8f8f8');
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('G'.$typost.'',$t_jml_antrian);
		$objPHPExcel->getActiveSheet()->SetCellValue('H'.$typost.'',$t_email_sukses);
		$objPHPExcel->getActiveSheet()->SetCellValue('I'.$typost.'',$t_email_gagal);
		$objPHPExcel->getActiveSheet()->SetCellValue('J'.$typost.'',$t_email_terbaca);
		...
		$objPHPExcel->getActiveSheet()->getStyle('A'.$typost.':L'.$typost.'')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB('ffeeeeee');
	...
	function get_RowData($blth, $flagtrans, $cycle, $sent_from, $sent_to){
		...
		$sql_data = "
			...
			".$p_kirim."
			".$w_cycle."
			GROUP BY a.m_loading_id, to_char(a.create_date,'yyyy-mm-dd'), a.loading_file, a.total_customer, a.total_halaman,
				c.jml_email, d.jml_antrian, e.email_sukses, f.email_gagal,  et.email_terbaca, g.sample_sukses, h.sample_gagal
			ORDER BY a.m_loading_id
		";
	...
	function view_bodymailterbaca(){
		$read_email_id = $_REQUEST['read_email_id'];
		$sql_data = "SELECT body_email FROM read_email WHERE read_email_id = $read_email_id";
		$qry_data = pg_query($sql_data) or die('ERROR select summary detail: '.$sql_data);
		$row_data = pg_fetch_assoc($qry_data);
		echo '<pre>'.$row_data['body_email'].'</pre>';
	}
...
<script>
	function view_bodymailterbaca(val){
		var read_email_id = val;
		$.post('script_summary_detail.php?act=view_bodymailterbaca&read_email_id='+read_email_id,"",function(respon){
			$.fancybox(respon);
		});
	}
