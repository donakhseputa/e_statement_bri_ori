                    	...
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <tr height="30" style="font-weight:bold">
                                	...
                                	<td align="right"><?php echo number_format($total_pdf,0,'',',')?>&nbsp;&nbsp;</td>
                    	...
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <?php
									$i = 0;
									$sql_data = "
										SELECT flagtrans, blth,nomor_customer, nomor_rekening, nama, pdf_name, password_pdf, jml_hlm
										FROM detail
										WHERE m_loading_id = $m_loading_id
										ORDER BY nomor_customer, nomor_rekening, nama, pdf_name, password_pdf, jml_hlm
									";
                    ...
                    <tr>
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
								...
								$i = 0;
								$sql_data = "
									SELECT DISTINCT a.antrian_id, a.email, b.nama, b.nomor_rekening,
									  to_char(a.date_email_send,'DD-Mon-YYYY HH24:MI:SS') AS date_email_send,
