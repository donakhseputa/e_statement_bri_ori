                    	...
                    	<td>
                        	<table align="center" border="1" cellpadding="1" cellspacing="0" width="100%" style="border-collapse:collapse;">
                            	<tr height="30">
                                	...
                                	<td align="center" colspan="7" width="30%" bgcolor="#79BAEC"><b>EMAIL</b></td>
                                ...
                                <?php
									...
									$sql_data = "
										SELECT
											...
											g.sample_sukses,
											h.sample_gagal,
											(SELECT DISTINCT(count(tr_email_id)) as jml_email_others FROM bounce_inbox WHERE blth='$blth' AND m_loading_id=a.m_loading_id  AND sample_status is not true AND status='others')AS jml_email_others
										FROM m_loading a
...
LEFT JOIN antrian_email_history e ON d.antrian_id = e.antrian_id $wh_total GROUP BY a.m_loading_id 
									...
									<tr height="30">
										...
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_pdf&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?>')"><?php echo number_format($row_data['jml_pdf'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_pdf&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?>')"><?php echo number_format($row_data['jml_lembar'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#afeeee"><a onClick="window.open('script_summary_detail.php?act=show_list_hal&tipe=0&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?=$m_loading_id?>')"><?php echo number_format($row_data['jml_email_gratis'],0,'',',');?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#afeeee"><a onClick="window.open('script_summary_detail.php?act=show_list_hal&tipe=1&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?=$m_loading_id?>')"><?php echo number_format($row_data['jml_email_bayar'],0,'',',');?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#fafad2"><a onClick="window.open('script_summary_detail.php?act=show_list_email&tipe=1&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?=$m_loading_id?>')"><?php echo number_format($row_data['total_hlm_berbayar'],0,'',',');?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#deb887"><a onClick="window.open('script_summary_detail.php?act=show_total_email&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?=$m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['total_email'],0,'',',');?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#DDBBBB"><a onClick="window.open('script_summary_detail.php?act=show_list_antrian&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?>')"><?php echo number_format($row_data['jml_antrian'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#DDBBBB"><a onClick="window.open('script_summary_detail.php?act=show_email_dikirim&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['jml_email'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#DDBBBB"><a onClick="window.open('script_summary_detail.php?act=show_email_sukses&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['email_sukses'],0,'',',')?></a>&nbsp;&nbsp;<?php echo $msg_warning; ?></td>
										<td align="right" bgcolor="#DDBBBB"><a onClick="window.open('script_summary_detail.php?act=show_email_gagal&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['email_gagal'],0,'',',')?></a>&nbsp;&nbsp;<?php echo $msg_warning; ?></td>
										...
										<a onClick="window.open('script_summary_detail.php?act=show_email_terbaca&source=0&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['email_terbaca'],0,'',',');?></a>
										</td>
										<td height="100%" width="50%" style="font-size:8pt;background-color:#ffe4e1;" align="right">
										<!-- terbaca melalui img-->
										<a onClick="window.open('script_summary_detail.php?act=show_email_terbaca&source=1&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['gambar_terbaca']);?></a>
										</td>
										</tr>
										</table>
										<!-- END TABLE EMAIL TERBACA -->
										</td>
										<td align="right" bgcolor="#DDBBBB"><a onClick="window.open('script_summary_detail.php?act=show_email_others&pr=<?=$flagtrans?>&blth=<?=$blth?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['jml_email_others'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_email_sample_sukses&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['sample_sukses'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_email_sample_gagal&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['sample_gagal'],0,'',',')?></a>&nbsp;&nbsp;</td>
									</tr>
									<?php
                                ...
                                <tr height="30" style="font-weight:bold" bgcolor="#87ceeb">
                                	...
                                	<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_pdf&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_pdf,0,'',',')?></a>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($total_lembar,0,'',',')?>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#87ceeb"><a onClick="window.open('script_summary_detail.php?act=show_list_email&pr=<?=$flagtrans?>&tipe=0&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_email_gratis,0,'',',');?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#87ceeb"><a onClick="window.open('script_summary_detail.php?act=show_list_email&pr=<?=$flagtrans?>&tipe=1&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_email_bayar,0,'',',');?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#FFD700"><a onClick="window.open('script_summary_detail.php?act=show_list_email&pr=<?=$flagtrans?>&tipe=1&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_hlm_berbayar,0,'',',');?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#cd853f"><a onClick="window.open('script_summary_detail.php?act=show_total_email&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_semua_email,0,'',',');?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#CC9999"><a onClick="window.open('script_summary_detail.php?act=show_list_antrian&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_antrian,0,'',',')?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#CC9999"><a onClick="window.open('script_summary_detail.php?act=show_email_dikirim&tipe=2&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_email,0,'',',')?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#CC9999"><a onClick="window.open('script_summary_detail.php?act=show_email_sukses&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_e_sukses,0,'',',')?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#CC9999"><a onClick="window.open('script_summary_detail.php?act=show_email_gagal&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_e_gagal,0,'',',')?></a>&nbsp;&nbsp;</td>
									...
									<table border="0" style="border-collapse:collapse" width="100%" height="100%">
										...
										<td height="100%" width="50%" style="font-size:8pt;background-color:#fff0f5;" align="right">
										<!--terbaca selain melalui img-->
										<a onClick="window.open('script_summary_detail.php?act=show_email_terbaca&source=0&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_e_terbaca,0,'',',');?></a>
										</td>
										<td height="100%" width="50%" style="font-size:8pt;background-color:#eee5de;" align="right">
										<!-- terbaca melalui img-->
										<a onClick="window.open('script_summary_detail.php?act=show_email_terbaca&source=1&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_g_terbaca,0,'',',');?></a>
										</td>
										</tr>
										</table>
									<!-- END TABLE EMAIL TERBACA -->
									</td>
									<td align="right" bgcolor="#CC9999"><a onClick="window.open('script_summary_detail.php?act=show_email_others&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_e_others,0,'',',')?></a>&nbsp;&nbsp;</td>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                        	...
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										...
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_pdf<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}else{
								...
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_list_pdf&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}?>
                            </table>
                    	...
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <?php
									...
									$sql_datas = "
										SELECT d.flagtrans, d.blth, d.nomor_customer, d.nama, d.pdf_name, d.password_pdf, d.jml_hlm, d.nama_file, d.nomor_rekening
										FROM $tabeldetail d
										".$condv."
                                ...
                                <tr height="30">
                                	...
                                	<td align="center"><?php
									$pdf_location = "../pdf/".$flagnya.$row_data['blth']."/".$namafolder."/";?>
				...
				<div align="center">
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_list_pdf&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
            </body>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
				...
				<div align="center">
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_list_hal&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
            </body>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
					...
					<td><div align="center">';
                      if($_REQUEST['xls']<>'y'){  
					  $vetable .= pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_list_email&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
					$vetable .='</div></td>
					</tr>
					</table>
            ...
            <body>
            	<table align="center" border="0" width="1000">
                    	...
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								<tr height="20">
									...
									<a onClick="window.open('script_summary_detail.php?act=export_show_total_email&blth=<?php echo $blth;?>&pr=<?php echo $flagtrans;?><?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo $m_loading_id;?>&sof=<?php echo $sof;?>&xls=y&tipe=<?php echo $tipe;?>')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a>
					...
					<?php 
					  ...
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_total_email&pr='.$flagtrans.'&blth='.$blth.'&sof='.$sof.'&m_loading_id='.$m_loading_id.$periodekirim);
					  } ?>
					</div></td>
					</tr>
					</table>
	...
	$per_send = explode('|', $_REQUEST['periode_kirim']);
		...
		$sql_datas = "SELECT  
									...
									WHEN d.email is not null and d.date_email_callback is not null THEN 'F' ELSE 'NO STATUS' END AS delivery_status, 
									b.nomor_rekening AS policy_number, b.nama, 
									coalesce(d.email, c.email) AS email_address,
									c.tgl_antrian AS queue_date,
									(SELECT e.tgl_jadwal FROM m_jadwal e WHERE e.jadwal_id=c.jadwal_id)AS send_schedule,
									to_char(d.date_email_send, 'dd Mon yyyy hh24:mi') AS send_date,
									CASE
										WHEN c.email is not null and d.date_email_send is null THEN 'Masih di antrian. Format alamat email salah sehingga tidak bisa dikirim atau email belum dikirim.'
										ELSE d.ket_error
		...
		$F->mergeCellsByColumnAndRow(0,2,8,2)->setCellValue('A2', 'Keterangan Delivery Status: S=Success, F=Failed')->getStyle('A2')->applyFromArray($styleArray);
		...
		$F->getColumnDimension('H')->setWidth(65);
		...
		$objPHPExcel->getActiveSheet()->getStyle('A'.$Line.':H'.$Line.'')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB('ffdfdfdf');
		...
		$F->setCellValueExplicit('H'.$Line, "Pesan Error", PHPExcel_Cell_DataType::TYPE_STRING)->getStyle('H'.$Line)->applyFromArray($styleArray);
		...
		$queue_date = "-";
		$send_schedule = "-";
		$send_date = date("d-m-Y H:i:s", strtotime($row_data['send_date']));
		}
		...
		#$F->getStyle('J'.$Line.'')->applyFromArray($styleArray);
			...
			$F->setCellValueExplicit('A'.$Line, $nomor, PHPExcel_Cell_DataType::TYPE_STRING)
				...
				->setCellValueExplicit('G'.$Line, $send_date, PHPExcel_Cell_DataType::TYPE_STRING)
				->setCellValueExplicit('H'.$Line, $error_message, PHPExcel_Cell_DataType::TYPE_STRING);
		...
		header('Content-Disposition: attachment;filename="list_total_email_'.$m_loading_id.'.xls"');
...
function show_email_dikirim($con,$header_utama){
            ...
            <body>
            	<table align="center" border="0" width="1000">
                    	...
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								<tr height="20">
									...
									<td align="right">
									<?php if($_REQUEST['xls']<>'y'){ ?>
									<a onClick="window.open('script_summary_detail.php?act=export_excel_show_email_dikirim&pr=<?php echo $flagtrans;?>&blth=<?php echo $blth;?><?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo $m_loading_id;?>&xls=y&tipe=<?php echo $tipe;?>')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a>
									<?php } ?>
									</td>
                                </tr>
                            </table>
                        	...
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%" style="border-collapse:collapse;border-color:#000000">
								...
								<?php
									...
									*/
									...
									LEFT JOIN m_attach_file maf ON aeaf.m_attach_file_id = maf.m_attach_file_id
					...
					<?php 
                      if($_REQUEST['xls']<>'y'){  
					  if (!empty($sent_from)){ $periodekirim = '&periode_kirim='.$_GET['periode_kirim']; }
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_email_dikirim&pr='.$flagtrans.'&blth='.$blth.'&m_loading_id='.$m_loading_id.$periodekirim);
					  } ?>
					</div></td>
					</tr>
					</table>
	...
	$m_loading_id = $_REQUEST['m_loading_id'];
		...
		// Redirect output to a clients web browser (Excel5)
		header('Content-Type: application/vnd.ms-excel');
		header('Content-Disposition: attachment;filename="list_email_dikirim_'.$m_loading_id.'.xls"');
		header('Cache-Control: max-age=0');
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_list_antrian&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                        	...
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										<td><b>Periode: <?=$label?></b></td>
										<td align="right">
										<a onClick="window.open('script_summary_detail.php?act=export_excel_show_email_sukses<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a>
										</td>
									</tr>
								<?php
								} else {
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right">
										<!--<a onClick="window.open('script_summary_detail.php?act=show_email_sukses&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a>-->
										<a onClick="window.open('script_summary_detail.php?act=export_excel_show_email_sukses&blth=<?php echo $blth;?><?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>')"><img height="40px" title="testing download excel" src="../images/icons/xls_icon.gif" /></a>
										</td>
									</tr>
									<?php } ?>
                            </table>
				...
				<div align="center">
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_email_sukses&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
	...
	//** 18 Des 2013 **//
		...
		// Redirect output to a clients web browser (Excel5)
		header('Content-Type: application/vnd.ms-excel');
		header('Content-Disposition: attachment;filename="list_email_sukses_'.$m_loading_id.'.xls"');
		header('Cache-Control: max-age=0');
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
                    	...
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										<td><b>Periode: <?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=export_excel_show_email_gagal<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}else{
								...
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right">
										<!--<a onClick="window.open('script_summary_detail.php?act=show_email_gagal&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a>-->
										<a onClick="window.open('script_summary_detail.php?act=export_excel_show_email_gagal&blth=<?php echo $blth;?><?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>')"><img height="40px" title="testing download excel" src="../images/icons/xls_icon.gif" /></a>
										</td>
									</tr>
								<?php
								}?>
                    	...
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%" style="border-collapse:collapse;border-color:#000000;">
								...
								$sql_datas = "SELECT
									...
									GROUP BY te.antrian_id, te.nomor_rekening, te.email, te.date_email_send,
									 d.nama, d.size_pdf, te.date_email_callback, te.ket_error,
									 ml.loading_file
									ORDER BY te.date_email_send";
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_email_gagal&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
	...
	//** 18 Des 2013 **//
		...
		$objPHPExcel->getActiveSheet()->getStyle('A'.$Line.':L'.$Line.'')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB('ffdfdfdf');
		...
		$F->setCellValueExplicit('I'.$Line, "PDF Size", PHPExcel_Cell_DataType::TYPE_STRING)->getStyle('I'.$Line)->applyFromArray($styleArray);
		$F->setCellValueExplicit('J'.$Line, "Attachment Size/Brosur", PHPExcel_Cell_DataType::TYPE_STRING)->getStyle('J'.$Line)->applyFromArray($styleArray);
		$F->setCellValueExplicit('K'.$Line, "Total Size", PHPExcel_Cell_DataType::TYPE_STRING)->getStyle('K'.$Line)->applyFromArray($styleArray);
		$F->setCellValueExplicit('L'.$Line, "Berbayar", PHPExcel_Cell_DataType::TYPE_STRING)->getStyle('L'.$Line)->applyFromArray($styleArray);
		...
		$F->getStyle('L'.$Line.'')->applyFromArray($styleArray);
			...
			$F->setCellValueExplicit('A'.$Line, $nomor, PHPExcel_Cell_DataType::TYPE_STRING)
				...
				->setCellValueExplicit('I'.$Line, $total_size_estat, PHPExcel_Cell_DataType::TYPE_NUMERIC)
				->setCellValueExplicit('J'.$Line, $total_size_attachment, PHPExcel_Cell_DataType::TYPE_NUMERIC)
				->setCellValueExplicit('K'.$Line, $total_semua_attachment, PHPExcel_Cell_DataType::TYPE_NUMERIC)
				->setCellValueExplicit('L'.$Line, $sizeberbayar, PHPExcel_Cell_DataType::TYPE_NUMERIC);
				++$Line;
			$nomor+=1;
		}
		// Redirect output to a clients web browser (Excel5)
		header('Content-Type: application/vnd.ms-excel');
		header('Content-Disposition: attachment;filename="list_email_gagal_'.$m_loading_id.'.xls"');
		header('Cache-Control: max-age=0');
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_email_terbaca&source='.$source.'&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
                    	...
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail.php?act=show_email_others&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}?>
                            </table>
                    ...
                    <tr>
                    	<td>
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%" style="border-collapse:collapse">
								...
								FROM bounce_inbox a 
								LEFT JOIN tr_email b ON b.tr_email_id=a.tr_email_id WHERE a.blth='$blth' 
								$condv 
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_email_others&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_email_sample_sukses&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail.php','act=show_email_sample_gagal&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
	...
	function view_template(){
		...
		$flagtrans = $_REQUEST['flagtrans'];
		?>
        <iframe id="frame_view" src="script_summary_detail.php?act=load_template&blth=<?php echo $blth;?>&flagtrans=<?php echo $flagtrans;?>&antrian_id=<?=$antrian_id?>" height="670" width="900" frameborder="0" style="background-color:#fff">
        </iframe>
        <?
	}
	...
	function load_template(){
		...
		$sql_show = "SELECT a.email, a.status_sample,
						...
						c.email_from,
						d.alamat1, d.alamat2, d.alamat3, d.blth, d.nama_file, d.nama, d.pdf_name, d.password_pdf, d.tipe_kartu, d.email AS emailsebenarnya, d.ket_produk
					FROM tr_email a
		...
		$pdf_location = "../pdf/".$flagnya.$blth."/".$namafolder."/";
...
?>
		...
		var tr_email_id = val;
		$.post('script_summary_detail.php?act=view_bodymailterbaca&tr_email_id='+tr_email_id,"",function(respon){
			$.fancybox(respon);
		});
		}
		function view_bodymailothers(val){
		var tr_email_id = val;
		$.post('script_summary_detail.php?act=view_bodymailothers&tr_email_id='+tr_email_id,"",function(respon){
			$.fancybox(respon);
		});
		}
		...
		var blth = vel;
		var flagtrans = vul;
		$.post('script_summary_detail.php?act=view_template&blth='+blth+'&flagtrans='+flagtrans+'&antrian_id='+antrian_id,"",function(respon){
			$.fancybox(respon);
		});
		}
		</script>
