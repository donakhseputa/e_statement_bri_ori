...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script>
		...
		function export_load(){
			...
			//alert('script_daftar_loading.php?act='+tipe_rpt+'&blth='+blth+'&pr='+pr);
			
			window.open('script_daftar_loading.php?act='+tipe_rpt+'&blth='+blth+'&pr='+pr);
		}
	</script>
    <body>
            ...
            <tr>
            	<td height="500" align="center" valign="top">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                        	<td align="center">
                            	<input type="button" class="button" id="button_export" name="button_export" value="EXPORT" style="display:none" onclick="export_load()" />
                            </td>
                        </tr>
                        <tr>
...
<script>
	Loaddiv('div_blth','script_daftar_loading.php','act=blth&flagtrans=<?=$flagtrans?>');
</script>
<?
	pg_close($con);
?>