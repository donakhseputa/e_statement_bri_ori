    ...
    <script>
		...
		function export_rpt(){
			...
			if (tipe_rpt == 'xls'){
				...
				window.location.href='script_summary_detail_rev.php?act=xls&blth='+blth+'&pr='+pr+'&cycle='+cycle+'&periode_kirim='+periode_kirim+'&cekemail='+check_email;				
			}else{
				...
				window.open('script_summary_detail_rev.php?act='+tipe_rpt+'&blth='+blth+'&pr='+pr+'&cycle='+cycle+'&periode_kirim='+periode_kirim+'&cekemail='+check_email);
			}
		}
	</script>
    <body>
