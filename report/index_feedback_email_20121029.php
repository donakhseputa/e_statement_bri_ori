...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script>
		function check_nama_file(){
			...
			if(blth!=''){
				$("#chk_nama_file").removeAttr('disabled');
			}else{
				$("#chk_nama_file").removeAttr('checked');
				$("#chk_nama_file").attr('disabled','disabled');
				$("#nama_file").val('');
		...
		function show_report(){
			...
			if(cek){
				...
				//alert('script_feedback_email.php?act=show_report&flagtrans='+flagtrans+'&blth='+blth+'&nama_file='+nama_file+'&report_menu='+report_menu+'&tipe_report='+tipe_report);
                                	...
                                	<form name="form_feedback" id="form_feedback">
                                        <table width="90%" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" id="chk_nama_file" name="chk_nama_file" disabled="disabled" onclick="show_nama_file()" />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>&nbsp;</td>
                                                <td>
                                                    <select name="report_menu" id="report_menu" class="combobox" onchange="button_export_()">
                                            ...
                                            <tr>
                                                ...
                                                <td>&nbsp;</td>
                                                <td>
                                                    <select name="tipe_report" id="tipe_report" class="combobox" onchange="button_export_()">
                                                        <option value="0"></option>
