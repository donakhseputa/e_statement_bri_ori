                        	...
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <?php
									...
									<tr height="30">
										...
										<td align="right" bgcolor="#afeeee"><a onClick="window.open('script_summary_detail.php?act=show_list_pdf&tipe=3&pr=<?=$flagtrans?>&m_loading_id=<?=$m_loading_id?>')"><?php echo number_format($row_data['jml_pdf_bayar'],0,'',',');?></a>&nbsp;&nbsp;</td>
