...
LEFT JOIN antrian_email_history e ON d.antrian_id = e.antrian_id $wh_total GROUP BY a.m_loading_id 
									...
									*/
									...
									<tr height="30">
										...
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_pdf&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?>')"><?php echo number_format($row_data['jml_pdf'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_pdf&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?>')"><?php echo number_format($row_data['jml_lembar'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#afeeee"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_hal&tipe=0&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?=$m_loading_id?>')"><?php echo number_format($row_data['jml_email_gratis'],0,'',',');?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#afeeee"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_hal&tipe=1&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?=$m_loading_id?>')"><?php echo number_format($row_data['jml_email_bayar'],0,'',',');?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#fafad2"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_email&tipe=1&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?=$m_loading_id?>')"><?php echo number_format($row_data['total_hlm_berbayar'],0,'',',');?></a>&nbsp;&nbsp;</td>
										...
										<td align="right" bgcolor="#deb887"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_total_email&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?=$m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['total_email'],0,'',',');?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#DDBBBB"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_antrian&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?>')"><?php echo number_format($row_data['jml_antrian'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#DDBBBB"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_dikirim&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['jml_email'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right" bgcolor="#DDBBBB"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_sukses&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['email_sukses'],0,'',',')?></a>&nbsp;&nbsp;<?php echo $msg_warning; ?></td>
										...
										<a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_terbaca&source=0&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['email_terbaca'],0,'',',');?></a>
										</td>
										<td height="100%" width="50%" style="font-size:8pt;background-color:#ffe4e1;" align="right">
										<!-- terbaca melalui img-->
										<a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_terbaca&source=1&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['gambar_terbaca']);?></a>
										</td>
										</tr>
										</table>
										<!-- END TABLE EMAIL TERBACA -->
										</td>
										<td align="right" bgcolor="#DDBBBB"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_others&pr=<?=$flagtrans?>&blth=<?=$blth?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['jml_email_others'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_sample_sukses&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['sample_sukses'],0,'',',')?></a>&nbsp;&nbsp;</td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_sample_gagal&pr=<?=$flagtrans?>&blth=<?php echo $blth;?>&m_loading_id=<?php echo $m_loading_id?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>')"><?php echo number_format($row_data['sample_gagal'],0,'',',')?></a>&nbsp;&nbsp;</td>
									</tr>
									<?php
                                ...
                                <tr height="30" style="font-weight:bold" bgcolor="#87ceeb">
                                	...
                                	<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_pdf&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_pdf,0,'',',')?></a>&nbsp;&nbsp;</td>
                                	<td align="right"><?php echo number_format($total_lembar,0,'',',')?>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#87ceeb"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_email&pr=<?=$flagtrans?>&tipe=0&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_email_gratis,0,'',',');?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#87ceeb"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_email&pr=<?=$flagtrans?>&tipe=1&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_email_bayar,0,'',',');?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#FFD700"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_email&pr=<?=$flagtrans?>&tipe=1&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_hlm_berbayar,0,'',',');?></a>&nbsp;&nbsp;</td>
									
									
									<td align="right" bgcolor="#<?php echo ( !empty( $total_selisih) ? 'F08080': '3CB371'); ?>"><?php echo $total_selisih;?>&nbsp;&nbsp;</td>
									
									
                                	<td align="right" bgcolor="#cd853f"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_total_email&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_semua_email,0,'',',');?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#CC9999"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_antrian&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_antrian,0,'',',')?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#CC9999"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_dikirim&tipe=2&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_email,0,'',',')?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#CC9999"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_sukses&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_e_sukses,0,'',',')?></a>&nbsp;&nbsp;</td>
                                	<td align="right" bgcolor="#CC9999"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_gagal&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_e_gagal,0,'',',')?></a>&nbsp;&nbsp;</td>
									...
									<table border="0" style="border-collapse:collapse" width="100%" height="100%">
										...
										<td height="100%" width="50%" style="font-size:8pt;background-color:#fff0f5;" align="right">
										<!--terbaca selain melalui img-->
										<a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_terbaca&source=0&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_e_terbaca,0,'',',');?></a>
										</td>
										<td height="100%" width="50%" style="font-size:8pt;background-color:#eee5de;" align="right">
										<!-- terbaca melalui img-->
										<a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_terbaca&source=1&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_g_terbaca,0,'',',');?></a>
										</td>
										</tr>
										</table>
									<!-- END TABLE EMAIL TERBACA -->
									</td>
									<td align="right" bgcolor="#CC9999"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_others&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_e_others,0,'',',')?></a>&nbsp;&nbsp;</td>
                                	<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_sample_sukses&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_s_sukses,0,'',',')?></a>&nbsp;&nbsp;</td>
                                	<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_sample_gagal&pr=<?=$flagtrans?>&blth=<? echo $blth?><?php if (!empty($_GET['periode_kirim'])){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&m_loading_id=<?php echo trim($m_loading_id_all,'|')?>')"><?php echo number_format($total_s_gagal,0,'',',')?></a>&nbsp;&nbsp;</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                        	...
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										...
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_pdf<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}else{
								...
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_pdf&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}?>
                            </table>
				...
				<div align="center">
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_list_pdf&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
            </body>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
				...
				<div align="center">
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_list_hal&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
            </body>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
                    	...
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								$vetable .= '
									...
									<td align="right">
									<a onClick="window.open(\'script_summary_detail_rev_11.php?act=show_list_email&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&xls=y&tipe='.$tipe.'\')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a>
									</td>
                                </tr>'; 
                                    $vetable .= '
                            </table>
					...
					<td><div align="center">';
                      if($_REQUEST['xls']<>'y'){  
					  $vetable .= pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_list_email&pr='.$flagtrans.'&blth='.$blth.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
					$vetable .='</div></td>
					</tr>
					</table>
            ...
            <body>
            	<table align="center" border="0" width="1000">
					...
					<?php 
					  ...
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_total_email&blth='.$blth.'&pr='.$flagtrans.'&sof='.$sof.'&m_loading_id='.$m_loading_id.$periodekirim);
					  } ?>
					</div></td>
					</tr>
					</table>
...
$objWriter->save('php://output');
            ...
            <body>
            	<table align="center" border="0" width="1000">
					...
					<?php 
                      if($_REQUEST['xls']<>'y'){  
					  if (!empty($sent_from)){ $periodekirim = '&periode_kirim='.$_GET['periode_kirim']; }
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_email_dikirim&pr='.$flagtrans.'&blth='.$blth.'&m_loading_id='.$m_loading_id.$periodekirim);
					  } ?>
					</div></td>
					</tr>
					</table>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
                    	...
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										<td><b>Periode: <?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_antrian<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}else{
									if ($gtotal != true){$label='Periode: '.$blth;}
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_list_antrian&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}?>
                            </table>
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_list_antrian&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                        	...
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										<td><b>Periode: <?=$label?></b></td>
										<td align="right">
										<a onClick="window.open('script_summary_detail_rev_11.php?act=export_excel_show_email_sukses<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a>
										</td>
									</tr>
								<?php
								} else {
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right">
										<!--<a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_sukses&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a>-->
										<a onClick="window.open('script_summary_detail_rev_11.php?act=export_excel_show_email_sukses&blth=<?php echo $blth;?><?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>')"><img height="40px" title="testing download excel" src="../images/icons/xls_icon.gif" /></a>
										</td>
									</tr>
									<?php } ?>
                            </table>
				...
				<div align="center">
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_email_sukses&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
	...
	*/
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
                    	...
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										<td><b>Periode: <?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=export_excel_show_email_gagal<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}else{
								...
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right">
										<!--<a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_gagal&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a>-->
										<a onClick="window.open('script_summary_detail_rev_11.php?act=export_excel_show_email_gagal&blth=<?php echo $blth;?><?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>')"><img height="40px" title="testing download excel" src="../images/icons/xls_icon.gif" /></a>
										</td>
									</tr>
								<?php
								}?>
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_email_gagal&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
                    	...
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										<td><b>Periode: <?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_terbaca<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}else{
									if ($gtotal == true){$label='Periode: '.$blth;}else{$label='Nama File: '.$nama_file;}
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_terbaca&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}?>
                            </table>
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_email_terbaca&blth='.$blth.'&source='.$source.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
                    	...
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_others&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}?>
                            </table>
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_email_others&blth='.$blth.'&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
                    	...
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										<td><b>Periode: <?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_sample_sukses<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}else{
									if ($gtotal == true){$label='Periode: '.$blth;}else{$label='Nama File: '.$nama_file;}
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_sample_sukses&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}?>
                            </table>
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_email_sample_sukses&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
            	<table align="center" border="0" width="1000">
                    	...
                    	<td>
                        	<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								?>
									<tr height="30">
										<td><b>Periode: <?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_gagal<?php if (!empty($sent_from)){echo '&periode_kirim='.$_GET['periode_kirim'];}?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}else{
									if ($gtotal == true){$label='Periode: '.$blth;}else{$label='Nama File: '.$nama_file;}
								?>
									<tr height="30">
										<td><b><?=$label?></b></td>
										<td align="right"><a onClick="window.open('script_summary_detail_rev_11.php?act=show_email_gagal&blth=<?php echo $blth?>&pr=<?php echo $flagtrans;?>&m_loading_id=<?php echo $m_loading_id?>&xls=y')"><img height="40px" title="download excel" src="../images/icons/xls_icon.gif" /></a></td>
									</tr>
								<?php
								}?>
                            </table>
				 ...
				 <?php
                      if($_REQUEST['xls']<>'y'){  
					  echo pagings($offset,$jumlah_data,$limit,'div_paging','script_summary_detail_rev_11.php','act=show_email_sample_gagal&pr='.$flagtrans.'&m_loading_id='.$m_loading_id.'&tipe='.$tipe);
					  }
                    ?>
					</div>
					</td>
	...
	function view_template(){
		...
		$flagtrans = $_REQUEST['flagtrans'];
		?>
        <iframe id="frame_view" src="script_summary_detail_rev_11.php?act=load_template&blth=<?php echo $blth;?>&flagtrans=<?php echo $flagtrans;?>&antrian_id=<?=$antrian_id?>" height="670" width="900" frameborder="0" style="background-color:#fff">
        </iframe>
        <?
	}
...
?>
		...
		var tr_email_id = val;
		$.post('script_summary_detail_rev_11.php?act=view_bodymailterbaca&tr_email_id='+tr_email_id,"",function(respon){
			$.fancybox(respon);
		});
		}
		function view_bodymailothers(val){
		var tr_email_id = val;
		$.post('script_summary_detail_rev_11.php?act=view_bodymailothers&tr_email_id='+tr_email_id,"",function(respon){
			$.fancybox(respon);
		});
		}
		...
		var blth = vel;
		var flagtrans = vul;
		$.post('script_summary_detail_rev_11.php?act=view_template&blth='+blth+'&flagtrans='+flagtrans+'&antrian_id='+antrian_id,"",function(respon){
			$.fancybox(respon);
		});
		}
		</script>
