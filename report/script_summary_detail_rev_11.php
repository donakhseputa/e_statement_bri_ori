...
a.m_loading_id,
 ...
 gt.gambar_terbaca,
											...
											,(select min(date_email_send) from tr_email where loading_id = a.m_loading_id AND status_sample <>'t') as awal_kirim
											,(select max(date_email_send) from tr_email where loading_id = a.m_loading_id AND status_sample <>'t' ) as akhir_kirim
...
LEFT JOIN antrian_email_history e ON d.antrian_id = e.antrian_id $wh_total GROUP BY a.m_loading_id 
                                ...
                                <tr height="30" style="font-weight:bold" bgcolor="#87ceeb">
                                	<td align="center" colspan="10">T O T A L</td>
