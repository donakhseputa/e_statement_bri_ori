                        	...
                        	<table align="center" border="1" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <?php
									...
									$sql_data = "SELECT
														...
														(SELECT count(email)
															FROM vw_email x
															WHERE x.m_loading_id=a.m_loading_id) AS jml_email,
														(SELECT count(*)
													...
													FROM m_loading a
														INNER JOIN detail b
															ON b.m_loading_id = b.m_loading_id
									...
									//window.open('script_feedback_email.php?act=show_report&flagtrans=BC&blth=$blth&nama_file=$row_data['loading_file']&report_menu=2&tipe_report=1');
