...
<?
	...
	function combo_template($flagtrans){
		$sql_template = "SELECT template_email_id,nama_template FROM template_email WHERE flagtrans='$flagtrans' ORDER BY template_email_id ASC";
	...
	function load_template($flagtrans,$template_id)
	{
		...
		if($status == 't'){$stat = "AKTIF";}elseif($status == 'f'){$stat = "TIDAK AKTIF";}else{$stat = "";}
		...
		<form id="form_editor" name="form_editor" method="post">
            <table align="center" width="100%">
            	<tr>
                	<td width="15%">Template Name</td>
                    <td><input type="text" id="text_name" name="text_name" class="textbox_3" value="<?=$nama_template?>" disabled="disabled" /></td>
                </tr>
            	<tr>
                	<td>Mail Server</td>
                    <td><input type="text" id="text_mail_server" name="text_mail_server" class="textbox_4" value="<?=$mail_server?>" disabled="disabled" /></td>
                </tr>
            	<tr>
                	<td>Reply To</td>
            	...
            	<tr>
                	<td>From Name</td>
                    <td><input type="text" id="text_from_name" name="text_from_name" class="textbox_4" value="<?=$from_name?>" disabled="disabled" /></td>
                </tr>
            	<tr>
                	<td>Subject</td>
            	...
            	<tr>
                	<td>Status</td>
                    <td><input type="text" id="text_status" name="text_status" class="textbox_2" value="<?=$stat?>" disabled="disabled" /></td>
                </tr>
                <tr>
                    <td>Content</td>
                    <td style="border-color:#000; border-width:1px; border:solid"><?=$isi_email?></td>
                </tr>
                <tr>
                	<td>&nbsp;</td>
                    <td>
